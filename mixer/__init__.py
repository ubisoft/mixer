...
__version__ = "v0.16.1"  # Generated by inject_version.py
display_version = "v0.16.1+modifiers-4"  # Generated by inject_version.py

bl_info = {
    "name": "Mixer",
    "author": "Ubisoft Animation Studio",
    "description": "Collaborative 3D edition accross 3D Softwares",
    "version": (0, 16, 1),  # Generated by inject_version.py
    "blender": (2, 82, 0),
    "location": "",
