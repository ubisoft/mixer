...
safe_depsgraph_updates = [T.Camera, T.Image, T.Light, T.MetaBall, T.NodeTree, T.Scene, T.World]
...
safe_blenddata_collections = ["cameras", "images", "lights", "metaballs", "objects", "scenes", "worlds"]
