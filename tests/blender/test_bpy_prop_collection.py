...
"""
    ...
    def test_nodes_initial_sync(self):
        action = self.create + self.add_color_node
        self.send_string(action)
        self.assert_matches()

    def test_nodes_add(self):
        self.send_string(self.create)
        self.send_string(self.add_color_node)
        self.assert_matches()

    def test_nodes_remove_last(self):
        action = self.create + self.add_color_node
        self.send_string(action)
        self.send_string(self.remove_color_node)
        self.assert_matches()
    ...
    def test_nodes_remove_third(self):
        ...
        action = self.create + self.add_color_node + self.add_blackbody
        self.send_string(action)
